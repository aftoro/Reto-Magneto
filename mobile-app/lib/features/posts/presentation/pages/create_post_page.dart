...
class _CreatePostPageState extends ConsumerState<CreatePostPage>
  ...
  void _createPost() {
    if (_formKey.currentState!.validate()) {
      ...
      ref.read(postNotifierProvider.notifier).createPost(post);
    }
  }
  ...
  Widget build(BuildContext context) {
    ref.listen<PostState>(postNotifierProvider, (previous, next) {
      next.whenOrNull(
        postSuccess: (message, postUrl, storyUrl) {
          setState(() {
            _isLoading = false;
          });
          _loadingController?.reverse();
          
          // Navegar de vuelta a la app principal en el tab de Posts después de un breve delay
          Future.delayed(const Duration(milliseconds: 500), () {
            if (mounted) {
              // Regresar a la página principal y cambiar al tab de Posts (índice 1)
              Navigator.of(context).pushNamedAndRemoveUntil(
                '/main-app',
                (route) => false,
                arguments: {'initialIndex': 1}, // Tab de Posts
              );
            }
          });
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Genera contenido visual automáticamente',
                    style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDarkTextField(
                    ...
                    labelText: 'Tema del Post',
                    hintText: 'Consejos para mejorar tu CV',
                  ...
                  _buildDropdownField(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'informative', child: Text('Informativo')),
                    ],
                    onChanged: (value) {
                      setState(() {
                              ...
                              return Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Creando post...',
                                    style: TextStyle(
                                      color: Colors.white.withOpacity(0.8 + 0.2 * (_loadingAnimation?.value ?? 0.0)),
                                      fontSize: 16,
                                      fontWeight: FontWeight.w600,
                                    ),
                                  ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'La IA generará automáticamente una imagen basada en tu prompt y creará el post en Instagram',
                      style: TextStyle(
  ...
  Widget _buildSuccessView() {
    return AnimatedBuilder(
      animation: _successAnimation ?? const AlwaysStoppedAnimation(0.0),
      builder: (context, child) {
        return Transform.scale(
          scale: 0.8 + 0.2 * (_successAnimation?.value ?? 0.0),
          child: Opacity(
            opacity: _successAnimation?.value ?? 0.0,
            child: Center(
              child: Padding(
                padding: const EdgeInsets.all(24),
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Tu post ha sido generado y publicado en Instagram',
                      style: TextStyle(
                    ...
                    // Post URLs
                    if (_createdPostUrl != null || _createdStoryUrl != null) ...[
                      Container(
                        ...
                        child: Column(
                          children: [
                            if (_createdPostUrl != null) ...[
                              _buildUrlButton(
                                'Ver Post',
                                _createdPostUrl!,
                                Icons.photo_outlined,
                              ),
                              if (_createdStoryUrl != null) const SizedBox(height: 12),
                            ],
